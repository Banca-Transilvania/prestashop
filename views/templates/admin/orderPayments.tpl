...
{if $payments|count > 0}
    ...
    <div class="card mt-2">
        <div class="card-header">
            <h3>{l s='BT iPay Payments' mod='btipay' d='Modules.Btipay.Generalinfo'}</h3>
        </div>
        ...
        <div class="card-body">
            <table class="table">
                <thead>
                <tr>
                    <th>{l s='Payment ID' mod='btipay' d='Modules.Btipay.Orderpayments'}</th>
                    <th>{l s='IPay ID' mod='btipay' d='Modules.Btipay.Orderpayments'}</th>
                    <th>{l s='Amount' mod='btipay' d='Modules.Btipay.Orderpayments'}</th>
                    <th>{l s='Capture Amount' mod='btipay' d='Modules.Btipay.Orderpayments'}</th>
                    <th>{l s='Refund Amount' mod='btipay' d='Modules.Btipay.Orderpayments'}</th>
                    <th>{l s='Cancel Amount' mod='btipay' d='Modules.Btipay.Orderpayments'}</th>
                    <th>{l s='Status' mod='btipay' d='Modules.Btipay.Orderpayments'}</th>
                    <th>{l s='Type' mod='btipay' d='Modules.Btipay.Orderpayments'}</th>
                    <th>{l s='Updated Date' mod='btipay' d='Modules.Btipay.Orderpayments'}</th>
                </tr>
                </thead>
                <tbody>
...
{else}
    <p class="alert alert-info">{l s='No BT iPay payments found for this order.' mod='btipay' d='Modules.Btipay.Orderpayments'}</p>
{/if}