            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                        ...
                        'options' => array(
                            'query' => array(
                                array('id' => BTiPayConfig::ONE_PHASE, 'name' => $this->module->l('1-Phase – Immediate Settlement')),
                                array('id' => BTiPayConfig::TWO_PHASE, 'name' => $this->module->l('2-Phase – Post-Delivery Settlement'))
                            ),
                            'id' => 'id',
                            'name' => 'name'
                        )
                    ...
                    array(
                        ...
                        'is_bool' => true,
                        'values' => array(
                            array('id' => 'active_on', 'value' => true, 'label' => $this->module->l('Yes')),
                            array('id' => 'active_off', 'value' => false, 'label' => $this->module->l('No'))
                        ),
